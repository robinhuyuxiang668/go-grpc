...
var file_download_proto_rawDesc = []byte{
	...
	0x12, 0x0d, 0x64, 0x6f, 0x77, 0x6e, 0x6c, 0x6f, 0x61, 0x64, 0x5f, 0x67, 0x72, 0x70, 0x63, 0x22,
	...
	0x0a, 0x0c, 0x46, 0x69, 0x6c, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x1b,
	...
	0x6e, 0x74, 0x65, 0x6e, 0x74, 0x32, 0x5a, 0x0a, 0x0f, 0x44, 0x6f, 0x77, 0x6e, 0x4c, 0x6f, 0x61,
	0x64, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x47, 0x0a, 0x0c, 0x44, 0x6f, 0x77, 0x6e,
	0x4c, 0x6f, 0x61, 0x64, 0x46, 0x69, 0x6c, 0x65, 0x12, 0x16, 0x2e, 0x64, 0x6f, 0x77, 0x6e, 0x6c,
	0x6f, 0x61, 0x64, 0x5f, 0x67, 0x72, 0x70, 0x63, 0x2e, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74,
	0x1a, 0x1b, 0x2e, 0x64, 0x6f, 0x77, 0x6e, 0x6c, 0x6f, 0x61, 0x64, 0x5f, 0x67, 0x72, 0x70, 0x63,
	0x2e, 0x46, 0x69, 0x6c, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x30,
	0x01, 0x42, 0x10, 0x5a, 0x0e, 0x2f, 0x64, 0x6f, 0x77, 0x6e, 0x6c, 0x6f, 0x61, 0x64, 0x5f, 0x67,
...
var file_download_proto_goTypes = []interface{}{
	(*Request)(nil),      // 0: download_grpc.Request
	(*FileResponse)(nil), // 1: download_grpc.FileResponse
}
var file_download_proto_depIdxs = []int32{
	0, // 0: download_grpc.DownLoadService.DownLoadFile:input_type -> download_grpc.Request
	1, // 1: download_grpc.DownLoadService.DownLoadFile:output_type -> download_grpc.FileResponse
...
type DownLoadServiceClient interface {
	DownLoadFile(ctx context.Context, in *Request, opts ...grpc.CallOption) (DownLoadService_DownLoadFileClient, error)
}
...
func (c *downLoadServiceClient) DownLoadFile(ctx context.Context, in *Request, opts ...grpc.CallOption) (DownLoadService_DownLoadFileClient, error) {
	stream, err := c.cc.NewStream(ctx, &_DownLoadService_serviceDesc.Streams[0], "/download_grpc.DownLoadService/DownLoadFile", opts...)
	if err != nil {
		return nil, err
	}
...
func (x *downLoadServiceDownLoadFileClient) Recv() (*FileResponse, error) {
	m := new(FileResponse)
...
type DownLoadServiceServer interface {
	DownLoadFile(*Request, DownLoadService_DownLoadFileServer) error
}
...
func (*UnimplementedDownLoadServiceServer) DownLoadFile(*Request, DownLoadService_DownLoadFileServer) error {
...
func (x *downLoadServiceDownLoadFileServer) Send(m *FileResponse) error {
	return x.ServerStream.SendMsg(m)
}

var _DownLoadService_serviceDesc = grpc.ServiceDesc{
	ServiceName: "download_grpc.DownLoadService",
